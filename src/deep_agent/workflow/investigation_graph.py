...
def create_investigation_graph(checkpointer=None):
    ...
    builder.add_node("build_context_manifest", build_context_manifest_node)
    ...
    builder.add_edge(START, "build_context_manifest")
    builder.add_edge("build_context_manifest", "extract_business_entities")
